...
var options, chart, chartBubbleSimpleColors = getChartColorsArray("simple_bubble"),
    chartBubbleColors = (chartBubbleSimpleColors && (options = {
        series: [{
            name: "Bubble1",
    ...
    }, (chart = new ApexCharts(document.querySelector("#simple_bubble"), options)).render()), getChartColorsArray("bubble_chart"));
chartBubbleColors && (options = {
    series: [{
        name: "Product1",
        data: generateData(new Date("11 Feb 2017 GMT").getTime(), 20, {
            min: 10,
