try {
    var setEndDate1 = "March 19, 2024 6:0:0",
        setEndDate2 = "April 16, 2024 5:3:1",
        setEndDate3 = "Dec 01, 2024 1:0:1",
        setEndDate4 = "Nov 26, 2024 1:2:1",
        setEndDate5 = "May 27, 2024 1:6:6",
        setEndDate6 = "May 20, 2024 2:5:5",
        setEndDate7 = "June 10, 2024 5:1:4",
        setEndDate8 = "June 25, 2024 1:6:3",
        setEndDate9 = "July 08, 2024 1:5:2";
    ...
    document.getElementById("auction-time-1") && setInterval(function() {
        countDownTimer(cdd1, "auction-time-1")
    }, 1e3), document.getElementById("auction-time-2") && setInterval(function() {
        countDownTimer(cdd2, "auction-time-2")
    }, 1e3), document.getElementById("auction-time-3") && setInterval(function() {
        countDownTimer(cdd3, "auction-time-3")
    }, 1e3), document.getElementById("auction-time-4") && setInterval(function() {
        countDownTimer(cdd4, "auction-time-4")
    }, 1e3), document.getElementById("auction-time-5") && setInterval(function() {
        countDownTimer(cdd5, "auction-time-5")
    }, 1e3), document.getElementById("auction-time-6") && setInterval(function() {
        countDownTimer(cdd6, "auction-time-6")
    }, 1e3), document.getElementById("auction-time-7") && setInterval(function() {
        countDownTimer(cdd7, "auction-time-7")
    }, 1e3), document.getElementById("auction-time-8") && setInterval(function() {
        countDownTimer(cdd8, "auction-time-8")
    }, 1e3), document.getElementById("auction-time-9") && setInterval(function() {
