...
function loadCandidateListData(e, t) {
    ...
    for (var n, i = (t - 1) * itemsPerPage; i < t * itemsPerPage && i < e.length; i++) e[i] && (n = e[i].userImg ? '<img src="' + e[i].userImg + '" alt="" class="member-img img-fluid d-block rounded" />' : '<div class="avatar-title border bg-light text-primary rounded text-uppercase fs-24">' + e[i].nickname + "</div>", document.querySelector("#candidate-list").innerHTML += '<div class="col-xxl-3 col-md-6">    <div class="card">        <div class="card-body">            <div class="d-flex align-items-center">                <div class="flex-shrink-0">                    <div class="avatar-lg rounded">' + n + '</div>                </div>                <div class="flex-grow-1 ms-3">                    <a href="pages-profile.html">                        <h5 class="fs-16 mb-1">' + e[i].candidateName + '</h5>                    </a>                    <p class="text-muted mb-2">' + e[i].designation + '</p>                    <div class="d-flex flex-wrap gap-2 align-items-center">                    <div class="badge text-bg-success"><i class="mdi mdi-star me-1"></i>' + e[i].rating[0] + '</div>                        <div class="text-muted">' + e[i].rating[1] + '</div>                    </div>                    <div class="d-flex gap-4 mt-2 text-muted">                        <div>                            <i class="ri-map-pin-2-line text-primary me-1 align-bottom"></i> ' + e[i].location + '</div>                        <div>                            <i class="ri-time-line text-primary me-1 align-bottom"></i>' + isStatus(e[i].type) + "                        </div>                    </div>                </div>            </div>        </div>    </div></div>");
