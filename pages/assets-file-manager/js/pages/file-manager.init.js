...
}), favouriteBtn(), Array.from(document.querySelectorAll(".file-manager-menu a")).forEach(function(i) {
...
var removeProduct = document.getElementById("removeFolderModal"),
    date = (removeProduct && removeProduct.addEventListener("show.bs.modal", function(t) {
...
function editFileList() {
    ...
    Array.from(document.querySelectorAll(".edit-list")).forEach(function(t) {
        t.addEventListener("click", function(e) {
            l = t.getAttribute("data-edit-id"), allFileList = allFileList.map(function(e) {
                return e.id == l && (editFlag = !0, document.getElementById("addNewFile").innerHTML = "Save", document.getElementById("createFileModalLabel").innerHTML = "File Rename", document.getElementById("filename-input").value = e.fileName, document.getElementById("fileid-input").value = e.id), e
            })
        })
    })
}
Array.from(document.querySelectorAll(".createFile-modal")).forEach(function(e) {
    e.addEventListener("click", function(e) {
        document.getElementById("addNewFile").innerHTML = "Create", document.getElementById("createFileModalLabel").innerHTML = "Create File", document.getElementById("filename-input").value = "", document.getElementById("fileid-input").value = "", document.getElementById("createfile-form").classList.remove("was-validated")
    })
}), Array.from(document.querySelectorAll(".create-folder-modal")).forEach(function(e) {
    e.addEventListener("click", function(e) {
        document.getElementById("addNewFolder").innerHTML = "Add Folder", document.getElementById("createFolderModalLabel").innerHTML = "Create Folder", document.getElementById("folderid-input").value = "", document.getElementById("foldername-input").value = "", document.getElementById("createfolder-form").classList.remove("was-validated")
    })
});
...
function sortElementsById() {
    loadFileData(allFileList.sort(function(e, t) {
    ...
    Array.from(document.querySelectorAll(".remove-list")).forEach(function(t) {
        t.addEventListener("click", function(e) {
            l = t.getAttribute("data-id"), document.getElementById("remove-fileitem").addEventListener("click", function() {
                var t;
                t = l, loadFileData(allFileList = allFileList.filter(function(e) {
                    return e.id != t
                })), document.getElementById("close-removefilemodal").click(), document.getElementById("file-overview").style.display = "none", document.getElementById("folder-overview").style.display = "block"
            })
        })
    })
}
...
function fileDetailShow() {
    var d = document.getElementsByTagName("body")[0],
        t = (Array.from(document.querySelectorAll(".close-btn-overview")).forEach(function(e) {
            e.addEventListener("click", function() {
            ...
            r.querySelector(".viewfile-list").addEventListener("click", function() {
                ...
                document.querySelector("#file-overview .file-icon i").className = t, Array.from(document.querySelectorAll("#file-overview .file-name")).forEach(function(e) {
                    e.innerHTML = l
                    ...
                    e.innerHTML = n
                }), document.querySelector("#file-overview .file-type").innerHTML = o, document.querySelector("#file-overview .remove-file-overview").setAttribute("data-remove-id", e), r.querySelector(".favourite-btn").classList.contains("active") ? document.querySelector("#file-overview .favourite-btn").classList.add("active") : document.querySelector("#file-overview .favourite-btn").classList.remove("active")
            })
        }), !1),
    ...
    Array.from(document.querySelectorAll(".remove-file-overview")).forEach(function(t) {
        t.addEventListener("click", function(e) {
            l = t.getAttribute("data-remove-id"), document.getElementById("remove-fileitem").addEventListener("click", function() {
                ...
                t = l, loadFileData(allFileList = allFileList.filter(function(e) {
                    return e.id != t
                })), document.getElementById("close-removefilemodal").click(), document.getElementsByTagName("body")[0].classList.remove("file-detail-show")
            })
        })
    })
}
...
Array.prototype.slice.call(createFileForms).forEach(function(n) {
    n.addEventListener("submit", function(e) {
        var t, l, i;
        n.checkValidity() ? (e.preventDefault(), t = document.getElementById("filename-input").value, l = Math.floor(100 * Math.random()), "" === t || editFlag ? "" !== t && editFlag && (i = 0, i = document.getElementById("fileid-input").value, allFileList = allFileList.map(function(e) {
            return e.id == i ? {
                id: e.id,
        ...
        }), editFlag = !1, document.getElementById("addFileBtn-close").click()) : (allFileList.push({
            id: l,
            fileName: t + ".txt",
            filetype: "Documents",
            fileItem: "01",
            ...
            date: date,
            starred: !1
        }), sortElementsById(), document.getElementById("addFileBtn-close").click()), loadFileData(allFileList), document.getElementById("addNewFile").innerHTML = "Create", document.getElementById("createFileModalLabel").innerHTML = "Create File") : (e.preventDefault(), e.stopPropagation()), n.classList.add("was-validated")
    }, !1)
