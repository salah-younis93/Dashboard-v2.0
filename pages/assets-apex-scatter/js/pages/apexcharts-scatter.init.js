...
chartScatterBasicColors && (options = {
    series: [{
        name: "SAMPLE A",
        data: [
            [16.4, 5.4],
...
var options, chart, chartScatterDateTimeColors = getChartColorsArray("datetime_scatter"),
    chartScatterImagesColors = (chartScatterDateTimeColors && (options = {
        series: [{
            name: "TEAM 1",
    ...
    }, (chart = new ApexCharts(document.querySelector("#datetime_scatter"), options)).render()), getChartColorsArray("images_scatter"));
chartScatterImagesColors && (options = {
    series: [{
        name: "User A",
        data: [
            [16.4, 5.4],
