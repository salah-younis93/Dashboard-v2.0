...
function H(n, l, u, i, t) {
    ...
    n: if ("style" === l)
        if ("string" == typeof u) n.style.cssText = u;
            ...
            if (u)
                for (l in u) i && u[l] === i[l] || $(n.style, l, u[l])
        }
...
function L(l, u, i, t, o, r, e, c) {
    ...
    if (null === d) y === p || c && l.data === p || (l.data = p);
        ...
        else if (k = u.props.children, w(l, Array.isArray(k) ? k : [k], u, i, t, o && "foreignObject" !== d, r, e, r ? r[0] : i.__k && _(i, 0), c), null != r)
...
export {
    P as render, S as hydrate, h as createElement, h, p as Fragment, y as createRef, i as isValidElement, d as Component, q as cloneElement, B as createContext, x as toChildArray, l as options
};
