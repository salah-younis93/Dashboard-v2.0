! function(t, e) {
    ...
    function w(t, e, n) {
        ...
        if (arguments.length > 2 && (s.children = arguments.length > 3 ? l.call(arguments, 2) : n), "function" == typeof t && null != t.defaultProps)
    ...
    function E() {
        for (var t; E.__r = f.length;) t = f.sort(function(t, e) {
    ...
    function F(t, e, n, r, i, o, s, a, u, l) {
        var c, p, h, f, d, _, v, y = r && r.__k || g,
            b = y.length;
        for (n.__k = [], c = 0; c < e.length; c++)
            if (null != (f = n.__k[c] = null == (f = e[c]) || "boolean" == typeof f ? null : "string" == typeof f || "number" == typeof f || "bigint" == typeof f ? P(null, f, null, null, f) : Array.isArray(f) ? P(S, {
                    children: f
                }, null, null, null) : f.__b > 0 ? P(f.type, f.props, f.key, null, f.__v) : f)) {
        ...
        for (n.__e = _, c = b; c--;) null != y[c] && ("function" == typeof n.type && null != y[c].__e && y[c].__e == n.__d && (n.__d = C(r, c + 1)), j(y[c], y[c]));
        if (v)
    ...
    function R(t, e, n) {
        "-" === e[0] ? t.setProperty(e, n) : t[e] = null == n ? "" : "number" != typeof n || v.test(e) ? n : n + "px"
    }
    ...
    function U(t, e, n, r, i, o, s, a, u) {
        ...
        try {
            t: if ("function" == typeof x) {
                ...
                if (p.context = b, p.props = g, p.__v = e, p.__P = t, w = c.__r, P = 0, "prototype" in x && x.prototype.render) p.state = p.__s, p.__d = !1, w && w(e), l = p.render(p.props, p.state, p.context);
                else
                    do {
                        p.__d = !1, w && w(e), l = p.render(p.props, p.state, p.context), p.state = p.__s
                    } while (p.__d && ++P < 25);
                p.state = p.__s, null != p.getChildContext && (r = y(y({}, r), p.getChildContext())), h || null == p.getSnapshotBeforeUpdate || (_ = p.getSnapshotBeforeUpdate(f, d)), C = null != l && l.type === S && null == l.key ? l.props.children : l, F(t, Array.isArray(C) ? C : [C], e, n, r, i, o, s, a, u), p.base = e.__e, e.__h = null, p.__h.length && s.push(p), m && (p.__E = p.__ = null), p.__e = !1
            } else null == o && e.__v === n.__v ? (e.__k = n.__k, e.__e = n.__e) : e.__e = M(n.__e, e, n, r, i, o, s, u);
            (l = c.diffed) && l(e)
        }
        catch (t) {
            e.__v = null, (u || null != o) && (e.__e = a, e.__h = !!u, o[o.indexOf(a)] = null), c.__e(t, e, n)
        }
    }

    function H(t, e) {
        c.__c && c.__c(e, t), t.some(function(e) {
            try {
    ...
    function M(t, e, n, r, i, o, s, a) {
        ...
        if ("svg" === d && (i = !0), null != o)
            for (; _ < o.length; _++)
                if ((u = o[_]) && "setAttribute" in u == !!d && (d ? u.localName === d : 3 === u.nodeType)) {
                    t = u, o[_] = null;
                    break
                }
        if (null == t) {
        ...
        if (null === d) h === f || a && t.data === f || (t.data = f);
            ...
            if (o = o && l.call(t.childNodes), c = (h = n.props || m).dangerouslySetInnerHTML, p = f.dangerouslySetInnerHTML, !a) {
                if (null != o)
            ...
            a || ("value" in f && void 0 !== (_ = f.value) && (_ !== t.value || "progress" === d && !_ || "option" === d && _ !== h.value) && A(t, "value", _, h.value, !1), "checked" in f && void 0 !== (_ = f.checked) && _ !== t.checked && A(t, "checked", _, h.checked, !1))
        }
        return t
    }
    ...
    function j(t, e, n) {
        var r, i;
        if (c.unmount && c.unmount(t), (r = t.ref) && (r.current && r.current !== t.__e || O(r, null, e)), null != (r = t.__c)) {
    ...
    l = g.slice, c = {
        ...
        var n;
        n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = y({}, this.state), "function" == typeof t && (t = t(y({}, n), this.props)), t && y(n, t), null != t && this.__v && (e && this.__h.push(e), N(this))
    ...
    var ft = /*#__PURE__*/ function() {
        ...
        dt = /*#__PURE__*/ function(t) {
            ...
            return i(e, t), e.prototype.render = function() {
                ...
                if (this.props.pluginId) {
                    ...
                    return e ? w(S, {}, w(e.component, r({
                        plugin: e
                    }, e.props, this.props.props))) : null
                }
                return void 0 !== this.props.position ? w(S, {}, this.config.plugin.list(this.props.position).map(function(e) {
                    return w(e.component, r({
                        plugin: e
        ...
        _t = /*#__PURE__*/ function(t) {
            function e(e, n) {
                ...
                var i, o = e.keyword;
                return e.enabled && (o && r.actions.search(o), r.storeUpdatedFn = r.storeUpdated.bind(s(r)), r.store.on("updated", r.storeUpdatedFn), i = e.server ? new ct({
                    keyword: e.keyword,
                    url: e.server.url,
                    body: e.server.body
                }) : new nt({
    ...
    var mt = /*#__PURE__*/ function(t) {
        ...
        vt = /*#__PURE__*/ function(t) {
            ...
            return r.componentWillMount = function() {
                ...
                return this.state.page + Math.floor(e / 2) >= this.pages && (n = e - (this.pages - this.state.page)), w(S, null, this.pages > e && this.state.page - n > 0 && w(S, null, w("button", {
                    tabIndex: 0,
                    role: "button",
                ...
                }), this.pages > e && this.pages > this.state.page + n + 1 && w(S, null, w("button", {
                    tabIndex: -1,
                    className: it(rt("spread"), this.config.className.paginationButton)
                }, "..."), w("button", {
                    tabIndex: 0,
                ...
                return w(S, null, this.props.summary && this.state.total > 0 && w("div", {
                    role: "status",
                    "aria-live": "polite",
                ...
                }, this._("pagination.showing"), " ", w("b", null, this._("" + (this.state.page * this.state.limit + 1))), " ", this._("pagination.to"), " ", w("b", null, this._("" + Math.min((this.state.page + 1) * this.state.limit, this.state.total))), " ", this._("pagination.of"), " ", w("b", null, this._("" + this.state.total)), " ", this._("pagination.results")))
            }, r.render = function() {
                return this.props.enabled ? w("div", {
                    className: it(rt("pagination"), this.config.className.pagination)
                }, this.renderSummary(), w("div", {
                    className: rt("pages")
                ...
                }, this._("pagination.previous")), this.renderPages(), this.props.nextButton && w("button", {
                    tabIndex: 0,
                    role: "button",
    ...
    var wt = /*#__PURE__*/ function(t) {
        ...
        return n.widths = function() {
            ...
            var t = this;
            return this.props.tableRef.current ? w("div", {
                ref: function(e) {
    ...
    var St = /*#__PURE__*/ function(e) {
            ...
            return s.adjustWidth = function(t) {
                ...
                for (var p, h = u(o.tabularFormat(this.columns).reduce(function(t, e) {
                    ...
                    var f = p.value;
                    f.columns && f.columns.length > 0 || (!f.width && i ? f.id in l && (f.width = bt(l[f.id].width), f.minWidth = bt(l[f.id].minWidth)) : f.width = bt(yt(f.width, s)))
                }
                ...
                for (var e, n = new o, r = u(t); !(e = r()).done;) {
                    var i = e.value;
                    if ("string" == typeof i || h(i)) n.columns.push({
                        name: i
                    });
        ...
        jt = /*#__PURE__*/ function() {
            ...
            return n.assign = function(t) {
                ...
                return i._userConfig = n, "boolean" == typeof n.sort && n.sort && i.assign({
                    ...
                    header: St.fromUserConfig(i)
                }), i.assign({
                    storage: Et.createFromUserConfig(n)
                }), i.assign({
                    pipeline: Ot.createFromConfig(i)
                }), i.assign({
                    translator: new G(n.language)
                }), i.plugin.add({
                    id: "search",
    ...
    var Wt, Bt, zt, qt, Vt = /*#__PURE__*/ function(t) {
            ...
            return n.content = function() {
                return this.props.column && "function" == typeof this.props.column.formatter ? this.props.column.formatter(this.props.cell.data, this.props.row, this.props.column) : this.props.column && this.props.column.plugin ? w(dt, {
        ...
        Gt = /*#__PURE__*/ function(t) {
            ...
            return n.getColumn = function(t) {
                ...
                var t = this;
                return this.props.children ? this.props.children : w(S, null, this.props.row.cells.map(function(e, n) {
                    var r = t.getColumn(n);
                    return r && r.hidden ? null : w(Vt, {
                        key: e.id,
                        cell: e,
                        row: t.props.row,
                        column: r
        ...
        Qt = /*#__PURE__*/ function(t) {
            ...
            return n.componentWillUnmount = function() {
                ...
                return n.length > 0 ? e = n[0] : (this.updateSortProcessorFn = this.updateSortProcessor.bind(this), this.store.on("updated", this.updateSortProcessorFn), e = t === Y.ServerSort ? new Jt(r({
                ...
                var t = this.state.direction,
                    e = "neutral";
                return 1 === t ? e = "asc" : -1 === t && (e = "desc"), w("button", {
                    tabIndex: -1,
        ...
        ee = /*#__PURE__*/ function(t) {
            ...
            return n.isSortable = function() {
                ...
                return void 0 !== this.props.column.name ? this.props.column.name : void 0 !== this.props.column.plugin ? w(dt, {
                ...
                var t = {};
                return this.isSortable() && (t.tabIndex = 0), w("th", r({
                    ref: this.thRef,
                    "data-column-id": this.props.column && this.props.column.id,
                ...
                }, this.getCustomAttributes(), t), w("div", {
                    className: rt("th", "content")
                }, this.content()), this.isSortable() && w(Qt, r({
                    ref: this.sortRef,
                    index: this.props.index
                }, this.props.column.sort)), this.isResizable() && this.props.index < this.config.header.visibleColumns.length - 1 && w(te, {
                    column: this.props.column,
                    thRef: this.thRef
                }))
            }, e
        ...
        ne = /*#__PURE__*/ function(t) {
            ...
            return n.renderColumn = function(t, e, n, r) {
                ...
                return w(Gt, null, t.map(function(t) {
                ...
                return this.props.header ? w("thead", {
        ...
        ie = /*#__PURE__*/ function(e) {
            ...
            return o.componentDidMount = function() {
                ...
                return this.state.isActive ? w("div", {
                    ref: this.headerRef,
        ...
        se = /*#__PURE__*/ function(t) {
            ...
            return n.processPipeline = function() {
                ...
                e.status != At.Rendered && this.state.status == At.Loaded && (this.setState({
                    status: At.Rendered
                }), this.props.config.eventEmitter.emit("ready"))
            }, n.render = function() {
                return w(this.configContext.Provider, {
                    value: this.props.config
                }, w("div", {
                    role: "complementary",
                    className: it("gridjs", rt("container"), this.state.status === At.Loading ? rt("loading") : null, this.props.config.className.container),
                    style: r({}, this.props.config.style.container, {
                        width: this.props.width
                    })
                }, this.state.status === At.Loading && w("div", {
    ...
    c.__b = function(t) {
        ...
        })) : (e.__h.forEach(ye), e.__h.forEach(be), e.__h = [])), zt = Bt
    }, c.diffed = function(t) {
        fe && fe(t);
        var e = t.__c;
        e && e.__H && (e.__H.__h.length && (1 !== le.push(e) && qt === c.requestAnimationFrame || ((qt = c.requestAnimationFrame) || function(t) {
            var e, n = function() {
                    clearTimeout(r), ve && cancelAnimationFrame(e), setTimeout(t)
                },
                r = setTimeout(n, 100);
            ve && (e = requestAnimationFrame(n))
        })(ge)), e.__H.__.forEach(function(t) {
            t.i && (t.__H = t.i), t.__V !== ce && (t.__ = t.__V), t.i = void 0, t.__V = ce
        })), zt = Bt = null
    }, c.__c = function(t, e) {
        e.some(function(t) {
            try {
                t.__h.forEach(ye), t.__h = t.__h.filter(function(t) {
                    return !t.__ || be(t)
                })
            } catch (n) {
                e.some(function(t) {
    ...
    }, t.h = w, t.html = K, t.useEffect = function(t, e) {
        var n = me(Wt++, 3);
