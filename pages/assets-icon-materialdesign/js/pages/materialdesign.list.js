...
function getIconItem(e, n) {
    ...
    return o.className = "col-xl-3 col-lg-4 col-sm-6", a.className = "mdi mdi-" + e.name, span = document.createElement("span"), o.appendChild(a), span.appendChild(document.createTextNode("mdi-" + e.name)), o.appendChild(span), o
}! function() {
    var e = [{
        name: "ab-testing",
        hex: "F01C9",
