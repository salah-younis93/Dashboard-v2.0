...
Array.prototype.slice.call(forms).forEach(function(i) {
    i.addEventListener("submit", function(e) {
        var t;
        i.checkValidity() ? (e.preventDefault(), "" === companyNameField.value || "" === ownerField.value || "" === industry_typeField.value || "" === star_valueField.value || "" === locationField.value || "" === employeeField.value || "" === websiteField.value || "" === contact_emailField.value || "" === sinceField.value || editlist ? "" !== companyNameField.value && "" !== ownerField.value && "" !== industry_typeField.value && "" !== star_valueField.value && "" !== locationField.value && "" !== employeeField.value && "" !== websiteField.value && "" !== contact_emailField.value && "" !== sinceField.value && editlist && (t = companyList.get({
            id: idField.value
