...
(form = document.getElementById("deals-form")).addEventListener("submit", function(e) {
    if (e.preventDefault(), form.checkValidity()) {
        ...
        document.getElementById("close-modal").click(), document.getElementById(e).innerHTML += o, form.reset(), Swal.fire({
            title: "Success!",
