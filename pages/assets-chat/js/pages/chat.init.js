function searchMessages() {
    ...
    function u(e, t, s, n, a) {
        ...
        if (null != t) r += '<div class="ctext-wrap-content" id=' + e + '><p class="mb-0 ctext-content">' + t + "</p></div>";
            ...
            r += "</div>"
        } else 0 < n.length && (r += '<div class="ctext-wrap-content">            <div class="p-3 border-primary border rounded-3">            <div class="d-flex align-items-center attached-file">                <div class="flex-shrink-0 avatar-sm me-3 ms-0 attached-file-avatar">                    <div class="avatar-title bg-soft-primary text-primary rounded-circle font-size-20">                        <i class="ri-attachment-2"></i>                    </div>                </div>                <div class="flex-grow-1 overflow-hidden">                    <div class="text-start">                        <h5 class="font-size-14 mb-1">design-phase-1-approved.pdf</h5>                        <p class="text-muted text-truncate font-size-13 mb-0">12.5 MB</p>                    </div>                </div>                <div class="flex-shrink-0 ms-4">                    <div class="d-flex gap-2 font-size-20 d-flex align-items-start">                        <div>                            <a href="#" class="text-muted">                                <i class="bx bxs-download"></i>                            </a>                        </div>                    </div>                </div>            </div>            </div>        </div>');
    ...
    function t(e) {
        ...
        e = e, t = function(e, t) {
            ...
            }), t = E.querySelectorAll(".reply-message"), i = document.querySelector(".replyCard"), l = document.querySelector("#close_toggle"), t.forEach(function(t) {
                t.addEventListener("click", function() {
                    o = !0, i.classList.add("show"), l.addEventListener("click", function() {
    ...
    e("chat-users-list.json", function(e, t) {
        null !== e ? console.log("Something went wrong: " + e) : (t[0].users.forEach(function(e, t) {
            var s = e.profile ? '<img src="' + e.profile + '" class="rounded-circle img-fluid userprofile" alt=""><span class="user-status"></span>' : '<div class="avatar-title rounded-circle bg-primary text-white fs-10">' + e.nickname + '</div><span class="user-status"></span>',
                n = e.messagecount ? '<div class="ms-auto"><span class="badge badge-soft-dark rounded p-1">' + e.messagecount + "</span></div>" : "",
            ...
            var s = e.messagecount ? '<div class="flex-shrink-0 ms-2"><span class="badge badge-soft-dark rounded p-1">' + e.messagecount + "</span></div>" : "",
    ...
    setInterval(y, 1e3);
    var x = 0;
    v && v.addEventListener("submit", function(e) {
        e.preventDefault();
        var e = a,
            t = a,
            s = g.value;
        ...
        }, 2e3)) : (1 == o ? (k(t, s), o = !1) : q(e, s), f(e || t)), g.value = "", document.getElementById("close_toggle").click()
    });
