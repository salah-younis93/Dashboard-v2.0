...
var chartCandlestickBasicColors = getChartColorsArray("basic_candlestick"),
    chartCandlestickComboColors = (chartCandlestickBasicColors && (options = {
        series: [{
            data: [{
    ...
    }, (chart = new ApexCharts(document.querySelector("#basic_candlestick"), options)).render()), getChartColorsArray("combo_candlestick"));
chartCandlestickComboColors && (options = {
    series: [{
        data: seriesData
    }],
    chart: {
...
(chartCandlestickComboColors = getChartColorsArray("combo_candlestick_chart")) && (optionsBar = {
    series: [{
        name: "volume",
...
}, (chartBar = new ApexCharts(document.querySelector("#combo_candlestick_chart"), optionsBar)).render());
var optionsBar, chartBar, options, chart, chartCandlestickCategoryColors = getChartColorsArray("category_candlestick"),
    chartCandlestickLineColors = (chartCandlestickCategoryColors && (options = {
        series: [{
            name: "candle",
            data: [{
                x: new Date(15387786e5),
    ...
    }, (chart = new ApexCharts(document.querySelector("#category_candlestick"), options)).render()), getChartColorsArray("candlestick_with_line"));
chartCandlestickLineColors && (options = {
    series: [{
        name: "line",
        type: "line",
        data: [{
    ...
    tooltip: {
        ...
        custom: [function(e) {
            ...
            var t = e.seriesIndex,
                a = e.dataPointIndex,
                e = e.w;
            return '<div class="apexcharts-tooltip-candlestick"><div>Open: <span class="value">' + e.globals.seriesCandleO[t][a] + '</span></div><div>High: <span class="value">' + e.globals.seriesCandleH[t][a] + '</span></div><div>Low: <span class="value">' + e.globals.seriesCandleL[t][a] + '</span></div><div>Close: <span class="value">' + e.globals.seriesCandleC[t][a] + "</span></div></div>"
        }]
    },
    xaxis: {
        type: "datetime"
    }
}, (chart = new ApexCharts(document.querySelector("#candlestick_with_line"), options)).render());